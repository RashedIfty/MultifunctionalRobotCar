...
else if(results.value==0xFF10EF){IR_data=3;} 
else if(results.value==0xFF5AA5){IR_data=4;} 
else if(results.value==0xFF38C7 || results.value==0xFF6897){IR_data=5;} 
else if(results.value==0xFF38C7){IR_data=8;} 
else if(results.value==0xFFA25D){IR_data=9;} 
else if(results.value==0xFF629D){IR_data=10;} 
return IR_data;
}
...
//*******Ultrasonic_read by Technical Gudachari*********
